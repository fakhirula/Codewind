    ...
    <div class="container relative mx-auto">
        <div class="items-center flex flex-wrap">
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div class="">
                    <h1 class="text-white font-semibold text-5xl">Kisahku dimulai dari sini.</h1>
                    <p class="mt-4 text-lg text-gray-300">Ini adalah ringkasan simpel kehidupan seorang anak yang mengemban tugas sebagai anak Sulung.</p>
                </div>
            </div>
        </div>
    </div>
